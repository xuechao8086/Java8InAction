...
public class StreamTest {
    ...
    private void testFunc5() {
        ...
        List<String> list = IntStream.range(1, 100_000).mapToObj(String::valueOf).parallel().collect(
            Collectors.toList());
    ...
    public void testFunc6() {
        ...
        WordCounter parallelWordCount = parallelStream.reduce(new WordCounter(0, true), WordCounter::accumulate,
            WordCounter::combine);
    ...
    public void testFunc13() {
        String a = "abc.";
        String b = StringUtils.removeEndIgnoreCase(a, ".");
    ...
    @Test
    public <T> void testExecutor() {
        List<String> list = ImmutableList.of("xuechao", "zhao");
        ...
        CompletableFuture<List<String>> cf = allDoneFuture.thenApplyAsync(t ->
            futures.stream().map(CompletableFuture::join).collect(Collectors.toList())
        );
        //获取到多线程的多个返回值的集合
        List<String> reslutList = cf.join();
    }
